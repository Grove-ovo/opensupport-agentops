...
assert.match(ciCoreBoot, /container_id_for/);
assert.match(ciCoreBoot, /COMPOSE_PROJECT_NAME:-opensupport-agentops/);
assert.match(ciCoreBoot, /::error title=Core boot failure::/);
