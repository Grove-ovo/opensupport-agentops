...
| [Phase 7F Pre-Deployment Aggregate Gate](./phase-7f-pre-deployment-gate.md) | One reproducible go/no-go staging gate aggregating all Phase 7 evidence, production HTTP load evidence, residual risks, and rollback documentation | Active |
